...
const JsonViewer = ({ config, onClose }) => {
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ fontSize: '14px', color: '#718096', margin: 0 }}>
              This JSON defines the entire dashboard structure
            </p>
          </div>
          <div style={{ display: 'flex', gap: '8px' }}>
            <button
              ...
              style={{
                padding: '8px 16px',
                background: copied ? '#38a169' : '#4299e1',
                color: 'white',
                border: 'none',
                borderRadius: '6px',
                fontSize: '14px',
...
export default function DashboardPrototype() {
  ...
  const [viewMode, setViewMode] = useState('dashboard'); // 'dashboard' | 'split'
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f5f7fa' }}>
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
            <h1 style={{ fontSize: '28px', fontWeight: 700, margin: 0 }}>
              🎯 JSON-Driven Dashboard System
            </h1>
            <div style={{ display: 'flex', gap: '12px' }}>
              <button
                onClick={() => setViewMode(viewMode === 'dashboard' ? 'split' : 'dashboard')}
                style={{
                  padding: '10px 20px',
              ...
              >
                {viewMode === 'dashboard' ? '📊 Show Config Side-by-Side' : '📱 Dashboard Only'}
              </button>
              <button
          ...
          <div style={{
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: '12px', opacity: 0.9, marginBottom: '4px', textTransform: 'uppercase', letterSpacing: '0.05em', fontWeight: 600 }}>
                🤖 AI Agent Can Create/Modify These Configs
              </div>
              <div style={{ fontSize: '14px', opacity: 0.95 }}>
                This entire dashboard is generated from a JSON configuration. Switch dashboards to see different configs in action.
              </div>
            </div>
            <select 
      ...
      <div style={{
        ...
        gridTemplateColumns: viewMode === 'split' ? '1fr 400px' : '1fr',
        gap: '24px'
      }}>
        <div>
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div>
                <h2 style={{ fontSize: '26px', fontWeight: 700, marginBottom: '4px', margin: 0 }}>
                  {dashboardSpec.name}
                </h2>
                <p style={{ fontSize: '14px', margin: 0, opacity: 0.95, marginTop: '8px' }}>
              ...
              <div style={{
                ...
                <div style={{ fontSize: '24px', fontWeight: 700 }}>
                  {dashboardSpec.widgets.length}
                </div>
                <div style={{ fontSize: '12px', opacity: 0.9, textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                  Widgets
                </div>
              </div>
            </div>
