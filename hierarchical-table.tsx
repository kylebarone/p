...
const generateSalesDeptData = () => [
  { dept: 'Dept A', program: 'Program 1', qtd: { sales: 13200000, vPlan: -996849, comp: -0.082 }, ytd: { sales: 24500000, vPlan: 1250000, comp: 0.054 }, metrics: { units: 1240, margin: 0.28 } },
  { dept: 'Dept A', program: 'Program 2', qtd: { sales: 1530000, vPlan: 1530000, comp: 2.166 }, ytd: { sales: 3200000, vPlan: -450000, comp: -0.125 }, metrics: { units: 85, margin: 0.35 } },
  { dept: 'Dept A', program: 'Program 3', qtd: { sales: 8750000, vPlan: 520000, comp: 0.063 }, ytd: { sales: 18200000, vPlan: 980000, comp: 0.057 }, metrics: { units: 3200, margin: 0.22 } },
  { dept: 'Dept B', program: 'Program 4', qtd: { sales: 2915000, vPlan: 2915000, comp: 0 }, ytd: { sales: 6400000, vPlan: -125000, comp: -0.019 }, metrics: { units: 450, margin: 0.31 } },
  { dept: 'Dept B', program: 'Program 5', qtd: { sales: 4500000, vPlan: -340000, comp: -0.070 }, ytd: { sales: 9800000, vPlan: 650000, comp: 0.071 }, metrics: { units: 820, margin: 0.26 } },
  { dept: 'Dept C', program: 'Program 6', qtd: { sales: 6200000, vPlan: 380000, comp: 0.065 }, ytd: { sales: 12700000, vPlan: -220000, comp: -0.017 }, metrics: { units: 950, margin: 0.29 } },
  { dept: 'Dept C', program: 'Program 7', qtd: { sales: 3100000, vPlan: -185000, comp: -0.056 }, ytd: { sales: 7200000, vPlan: 420000, comp: 0.062 }, metrics: { units: 680, margin: 0.33 } }
];

const generateRegionalData = () => [
  { region: 'Region North', store: 'Store 1', month: { revenue: 2400000, traffic: 18500, conversion: 0.082 }, quarter: { revenue: 7800000, target: 7500000, attainment: 1.04 } },
  { region: 'Region North', store: 'Store 2', month: { revenue: 3800000, traffic: 28000, conversion: 0.095 }, quarter: { revenue: 11200000, target: 12000000, attainment: 0.933 } },
  { region: 'Region North', store: 'Store 3', month: { revenue: 1900000, traffic: 14200, conversion: 0.078 }, quarter: { revenue: 5600000, target: 6000000, attainment: 0.933 } },
  { region: 'Region South', store: 'Store 4', month: { revenue: 2200000, traffic: 16800, conversion: 0.088 }, quarter: { revenue: 6900000, target: 6500000, attainment: 1.062 } },
  { region: 'Region South', store: 'Store 5', month: { revenue: 2800000, traffic: 21000, conversion: 0.091 }, quarter: { revenue: 8400000, target: 8000000, attainment: 1.05 } },
  { region: 'Region West', store: 'Store 6', month: { revenue: 4200000, traffic: 25000, conversion: 0.102 }, quarter: { revenue: 13100000, target: 12500000, attainment: 1.048 } },
  { region: 'Region West', store: 'Store 7', month: { revenue: 3600000, traffic: 31000, conversion: 0.086 }, quarter: { revenue: 10800000, target: 11000000, attainment: 0.982 } }
];

const generateProductData = () => [
  { category: 'Category A', sku: 'Product A1', sales: { units: 2400, revenue: 360000, avgPrice: 150 }, inventory: { onHand: 450, onOrder: 200, turnRate: 5.2 } },
  { category: 'Category A', sku: 'Product A2', sales: { units: 1800, revenue: 432000, avgPrice: 240 }, inventory: { onHand: 280, onOrder: 150, turnRate: 6.4 } },
  { category: 'Category A', sku: 'Product A3', sales: { units: 3200, revenue: 384000, avgPrice: 120 }, inventory: { onHand: 520, onOrder: 300, turnRate: 6.1 } },
  { category: 'Category B', sku: 'Product B1', sales: { units: 4500, revenue: 135000, avgPrice: 30 }, inventory: { onHand: 850, onOrder: 0, turnRate: 5.3 } },
  { category: 'Category B', sku: 'Product B2', sales: { units: 2800, revenue: 168000, avgPrice: 60 }, inventory: { onHand: 420, onOrder: 200, turnRate: 6.7 } },
  { category: 'Category C', sku: 'Product C1', sales: { units: 18000, revenue: 126000, avgPrice: 7 }, inventory: { onHand: 3200, onOrder: 5000, turnRate: 5.6 } },
  { category: 'Category C', sku: 'Product C2', sales: { units: 12000, revenue: 144000, avgPrice: 12 }, inventory: { onHand: 2400, onOrder: 1000, turnRate: 5.0 } }
];

const generateEmployeeData = () => [
  { division: 'Division A', department: 'Department 1', headcount: { fte: 45, contractors: 8, vacancies: 3 }, costs: { salary: 6750000, benefits: 1350000, total: 8100000 }, performance: { avgRating: 4.2, turnover: 0.08 } },
  { division: 'Division A', department: 'Department 2', headcount: { fte: 18, contractors: 4, vacancies: 2 }, costs: { salary: 1980000, benefits: 396000, total: 2376000 }, performance: { avgRating: 4.0, turnover: 0.12 } },
  { division: 'Division A', department: 'Department 3', headcount: { fte: 12, contractors: 2, vacancies: 1 }, costs: { salary: 1920000, benefits: 384000, total: 2304000 }, performance: { avgRating: 4.3, turnover: 0.06 } },
  { division: 'Division B', department: 'Department 4', headcount: { fte: 28, contractors: 0, vacancies: 4 }, costs: { salary: 4200000, benefits: 840000, total: 5040000 }, performance: { avgRating: 3.8, turnover: 0.18 } },
  { division: 'Division B', department: 'Department 5', headcount: { fte: 35, contractors: 0, vacancies: 2 }, costs: { salary: 3500000, benefits: 700000, total: 4200000 }, performance: { avgRating: 3.9, turnover: 0.15 } },
  { division: 'Division C', department: 'Department 6', headcount: { fte: 22, contractors: 6, vacancies: 1 }, costs: { salary: 2200000, benefits: 440000, total: 2640000 }, performance: { avgRating: 4.1, turnover: 0.10 } },
  { division: 'Division C', department: 'Department 7', headcount: { fte: 32, contractors: 8, vacancies: 0 }, costs: { salary: 2560000, benefits: 512000, total: 3072000 }, performance: { avgRating: 4.0, turnover: 0.09 } }
];

const generateFinancialData = () => [
  { businessUnit: 'Unit A', productLine: 'Line A1', revenue: { gross: 45000000, returns: -2200000, net: 42800000 }, costs: { cogs: 28000000, operating: 8500000, total: 36500000 }, profit: { grossMargin: 0.378, ebitda: 9200000, netIncome: 6300000 } },
  { businessUnit: 'Unit A', productLine: 'Line A2', revenue: { gross: 18000000, returns: -900000, net: 17100000 }, costs: { cogs: 11500000, operating: 3200000, total: 14700000 }, profit: { grossMargin: 0.328, ebitda: 3800000, netIncome: 2400000 } },
  { businessUnit: 'Unit A', productLine: 'Line A3', revenue: { gross: 8500000, returns: -400000, net: 8100000 }, costs: { cogs: 3800000, operating: 2100000, total: 5900000 }, profit: { grossMargin: 0.531, ebitda: 3400000, netIncome: 2200000 } },
  { businessUnit: 'Unit B', productLine: 'Line B1', revenue: { gross: 32000000, returns: -1800000, net: 30200000 }, costs: { cogs: 22000000, operating: 5400000, total: 27400000 }, profit: { grossMargin: 0.272, ebitda: 4600000, netIncome: 2800000 } },
  { businessUnit: 'Unit B', productLine: 'Line B2', revenue: { gross: 24000000, returns: -1200000, net: 22800000 }, costs: { cogs: 16500000, operating: 4100000, total: 20600000 }, profit: { grossMargin: 0.277, ebitda: 3900000, netIncome: 2200000 } },
  { businessUnit: 'Unit C', productLine: 'Line C1', revenue: { gross: 52000000, returns: -3100000, net: 48900000 }, costs: { cogs: 35000000, operating: 9200000, total: 44200000 }, profit: { grossMargin: 0.284, ebitda: 7800000, netIncome: 4700000 } },
  { businessUnit: 'Unit C', productLine: 'Line C2', revenue: { gross: 28000000, returns: -1400000, net: 26600000 }, costs: { cogs: 18200000, operating: 5100000, total: 23300000 }, profit: { grossMargin: 0.316, ebitda: 5200000, netIncome: 3300000 } }
];
  ...
  return (
    <div className="w-full mb-6">
      <div className="mb-3 flex items-center gap-3">
        <h2 className="text-xl font-semibold text-green-700">{spec.name}</h2>
              ...
              <tr key={idx}>
                {row.map((cell, cellIdx) => (
                  <th
                    ...
                    className="bg-green-700 text-white px-4 py-3 text-sm font-semibold text-center border-r border-green-600 last:border-r-0"
                  >
                    {cell.label}
                  </th>
                ))}
                ...
                <React.Fragment key={groupKey}>
                  ...
                  >
                    <td 
                      ...
                      className="px-4 py-3 font-semibold border-r-2 border-green-300 align-top bg-green-50"
                    >
                      <div className="flex items-center gap-2">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 p-6">
      <div className="max-w-[1600px] mx-auto">
        ...
        {/* Documentation */}
        <div className="mt-8 bg-white rounded-lg shadow-lg p-6 border border-green-200">
